            ...
            <div class="row">
                ...
                <div class="col-lg-6 bg-white">
                    <div class="form d-flex align-items-center">
                        <div class="content">
                            <h1 class="mb-5">Agency Login</h1>
                            <form id="devloginFrm" name="devloginFrm" method="POST" action="{{ route('agency.login') }}">
                                @csrf
                            ...
                            @if (Route::has('agency.password.request'))
                            <a class="forgot-pass" href="{{ route('agency.password.request') }}">
