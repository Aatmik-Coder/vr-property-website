            ...
            <nav class="navbar">
                <div class="container-fluid px-0">
                    <div class="navbar-holder d-flex align-items-center justify-content-between">
                        ...
                        <div class="navbar-header">
                            <!-- Navbar Brand -->
                            <a href="{{ route('developer.dashboard') }}" class="navbar-brand d-none d-sm-inline-block">
                                <div class="brand-text d-none d-lg-inline-block">
                                    <img src="{{ asset('assets/common/images/logo.png') }}" class="logo-img">
                                    <!-- <strong>Dashboard</strong> -->
                                </div>
                            ...
                            <div>
                                <img src="{{ auth('developer')->user()->avatar_url }}" class="user-img" />
                                <a id="toggle-btn" href="#" class="menu-btn">
                                    <img src="{{ asset('assets/common/images/menu-icon.png') }}" class="menu-icon" />
                                </a>
                            </div>
                        ...
                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul aria-labelledby="settings" class="dropdown-menu">
                                    <li>
                                        <a rel="nofollow" href="{{ route('developer.profile.edit') }}" class="dropdown-item">Manage Profile</a>
                                    </li>
                                    <li>
                                        <a rel="nofollow" href="{{ route('developer.password.edit') }}" class="dropdown-item">Change Password</a>
                                    </li>
                                </ul>
                            </li>
                            <!-- Logout    -->
                            ...
                            <form id="logout-form" action="{{ route('developer.logout') }}" method="POST" style="display: none;">
                                @csrf
                            </form>
                        </ul>
                    </div>
