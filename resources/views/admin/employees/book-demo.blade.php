    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{!! route('employee.properties-assigned.book-demo',$id) !!}" method="POST" class="form-horizonatal" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4 offset-sm-3">
                                    ...
                                    <button type="button" class="btn btn-secondary" onclick="location.href='{{ URL('/employee/properties-assigned') }}';">Cancel</button>
                                </div>
                            </div>
                        </form>
                    </div>
